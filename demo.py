...
class Pixiv():
    ...
    def __init__(self):
       ...
       #                   'word=%E5%9B%9B%E6%9C%88%E3%81%AF%E5%90%9B%E3%81%AE%E5%98%98&order=date_d&p='
        self.target_url = 'https://www.pixiv.net/member_illust.php?id=153566&tag=%E6%9D%B1%E6%96%B9&type=all&p='
        ...
        self.pixiv_id = 'devilqmcq@outlook.com'
        self.password = 'qmcqh19961127'
        self.post_key = []
        self.return_to = 'http://www.pixiv.net/'
        self.load_path = '/Users/wangmingjian/Pictures/python_pixiv_webspider/pixiv_pic'
        self.ip_list = []
    ...
    def work(self):
        self.login()
        for page_num in range(1, 10):  # 太多页了,只跑50页===>修改成9页
