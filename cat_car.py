...
class Pixiv():
    ...
    def __init__(self):
        ...
        self.target_url = 'https://www.pixiv.net/member_illust.php?id=167342&tag=%E6%9D%B1%E6%96%B9&type=all&p='
        ...
        self.load_path = '/Users/wangmingjian/Pictures/python_pixiv_webspider/cat_car/image'
        self.ip_list = []
    ...
    def work(self):
        ...
        for page_num in range(1, 10):  #===>修改成9页,爬周榜之类的随意页数
            ...
            time.sleep(2)  # 防止太快被反（本来设定是sleep(2)）
